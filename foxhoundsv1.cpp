...
void Board::checkFoxes() {
    if ((isTrapped(list[4].getX(), list[4].getY()) == 1) || ((list[4] < list[0]) && (list[4] < list[1]) && (list[4] < list[3]) && (list[4] < list[3]))) {
        list[4].out();
    }
    if ((isTrapped(list[5].getX(), list[5].getY()) == 1) || ((list[5] < list[0]) && (list[5] < list[1]) && (list[5] < list[3]) && (list[5] < list[3]))) {
        list[5].out();
    }
}
void Board::execute() {
	...
	display();
	if (list[4].getY() == 1 && list[5].getY() == 1) {
		winner = 1;
	}
	else if (list[4].getY() == 1 || list[5].getY() == 1) {
		winner = 0;
	}
